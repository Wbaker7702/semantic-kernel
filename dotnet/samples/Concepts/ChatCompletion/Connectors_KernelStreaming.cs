...
public class Connectors_KernelStreaming(ITestOutputHelper output) : BaseTest(output)
{
    ...
    public async Task RunAsync()
    {
        ...
        var funnyParagraphFunction = kernel.CreateFunctionFromPrompt("Write a funny paragraph about streaming", new OpenAIPromptExecutionSettings() { MaxTokens = 225, Temperature = 0.75, TopP = 1 });
