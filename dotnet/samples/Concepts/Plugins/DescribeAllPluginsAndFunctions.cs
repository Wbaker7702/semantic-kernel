...
public class DescribeAllPluginsAndFunctions(ITestOutputHelper output) : BaseTest(output)
{
    ...
    public Task RunAsync()
    {
        ...
        var sFun1 = kernel.CreateFunctionFromPrompt("tell a joke about {{$input}}", new OpenAIPromptExecutionSettings() { MaxTokens = 225 });
        ...
        var sFun2 = kernel.CreateFunctionFromPrompt(
            ...
            new OpenAIPromptExecutionSettings() { MaxTokens = 225 },
            functionName: "Novel",
