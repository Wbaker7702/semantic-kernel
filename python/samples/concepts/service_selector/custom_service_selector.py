...
kernel.add_function(
    ...
    prompt_execution_settings={
        "gpt-4o": PromptExecutionSettings(service_id="gpt-4o", max_tokens=300, temperature=0.75),
        "gpt-3.5-turbo": PromptExecutionSettings(service_id="gpt-3.5-turbo", max_tokens=600, temperature=0.75),
    },
)
